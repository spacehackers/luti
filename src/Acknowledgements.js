...
const Acknowledgements = () => {
  ...
  return (
    <Page>
      ...
      <p>
        <a href="https://www.nsf.gov/funding/pgm_summ.jsp?pims_id=503518">National Science Foundation Antarctic Artists & Writers program</a>
      <br />
      ...
      <br />
        for being the lead music composer and a web developer for Life Under the Ice, using modular synths to set a mood for the microbes. Thanks also for being the best partner, cheerleader, and collaborator throughout.
      </p>

      <p>
        National Geographic
      <br />
        for supporting unaffiliated, independent explorers such as myself. National Geographic’s <a href="https://www.nationalgeographic.org/funding-opportunities/grants/what-we-fund/">exploration grant</a> allowed me to acquire a robust field-microscope setup, hire a web developer to help make this project come to fruition, and provided a modest stipend for the first couple months of my post-expedition microscopy work.
      </p>

      <p>
        <a href="https://en.wikipedia.org/wiki/Christopher_McKay">Chris McKay</a>
      <br />
      ...
      <br />
        for defending the merit of this project over the years, fighting for me to get what I needed for a successful expedition, and taking me under her wing while simultaneously showing me how to take charge in Antarctica. I’ll forever have fond memories of the week I spent camping at Lake Bonney, the site of Blood Falls and her <a href="http://astrobiology.com/2014/03/exploring-below-antarcticas-blood-falls.html">prime stomping ground</a>.
      </p>

      <p>
        All my patrons on <a href="https://patreon.com/arielwaldman">Patreon</a>
      <br />
        for being awesome humans and supporting my otherwise-unfunded work and lab equipment <a href="https://www.patreon.com/posts/heavy-sigh-and-11497109">over the years</a>. This included time spent: researching, developing and writing proposals, meeting with artists and scientists to solicit support, teaching myself microscopy, taking one year of classes and lab time at school to become certified in microscopy, figuring out permits, figuring out equipment needs, five months of working closely with NSF on logistics and preparing everything for my expedition, the five weeks I spent in Antarctica, production of a <a href="https://www.youtube.com/playlist?list=PLN_whQB72CoDyLvgy12QpPszBA808YxMW">five episode mini-series</a> about the expedition, and all the development that went into the creation of this website once I got back home.
      </p>

      <p>
        <a href="https://www.sfmicrosoc.org/">San Francisco Microscopical Society</a>
      <br />
      ...
      <p>
        Merritt College
      <br />
        and specifically Gisele Giorgi for creating an inclusive microscopy program that welcomes students who want to use microscopes for science, art, or just a better paycheck. The <a href="https://www.merritt.edu/wp/microscopy/">Merritt Microscopy Program</a> certified me in optical microscopy, but more importantly gave me the confidence I needed to be a self-reliant microscopist in the field in Antarctica. Thanks also to Candy Mintz for giving me the confidence I need to run my own lab space.
      </p>

      <p>
        <a href="http://schmidt.eas.gatech.edu/project-rise-up/">Britney Schmidt & the Icefin team</a>
      <br />
        for your support, time, helpful advice, and welcoming me to ride along with your awesome robot.
      </p>

      <p>
        <a href="https://pacificasommers.com/">Pacifica Sommers</a>, <a href="https://entnemdept.ifas.ufl.edu/people-directory/dorota-porazinska/">Dorota Porazinska</a>, and Adam Solon
      <br />
        for helping me conquer hiking up my first glacier! I couldn’t have done it without their expertise, assistance, and patience. They literally helped me tie my shoes (crampons) at one point. All in service of exploring the many awesome microbes that live inside glaciers via <a href="https://cryoholes.wordpress.com/">cryoconite holes</a>. Thanks also to Dorota for giving me awesome pointers on how to filter microbes in the field.
      </p>

      <p>
        <a href="https://antarcticsun.usap.gov/features/4191/">Rob Robbins</a>, Steve Rupp, and <a href="http://www.henrykaiserguitar.com/">Henry Kaiser</a>
      <br />
      ...
      <p>
        <a href="https://nai.nasa.gov/directory/boston-penelope/">Penny Boston</a>
      <br />
      ...
      <p>
        <a href="https://www.nasa.gov/content/lynn-j-rothschild">Lynn Rothschild</a>
      <br />
        for offering a letter of support and being a champion of multidisciplinary collaboration.
      </p>

      <p>
        <a href="https://www.siena.edu/faculty-and-staff/person/matt-bellis/">Matt Bellis</a>
      <br />
      ...
      <p>
        <a href="https://twitter.com/ianbrunswick">Ian Brunswick</a> and <a href="https://twitter.com/shaunoboyle">Shaun O’Boyle</a>
      <br />
        for letters of support and being a welcoming interface to the awesome <a href="https://dublin.sciencegallery.com/">Science Gallery</a> network.
      </p>
      ...
      <p>
        <a href="https://www.seti.org/our-scientists/seth-shostak">Seth Shostak</a>
      <br />
      ...
      <p>
        <a href="https://sloan.org/about/staff/joshua-m-greenberg">Josh Greenberg</a>
      <br />
      ...
      <br />
        for helping me build my portfolio in the lead up to this project by letting me come take photos of the <a href="https://spacescience.arc.nasa.gov/microecobiogeo/">awesome microbial mats</a> you grow at NASA Ames.
      </p>
      ...
      <br />
        for rooting for me over the years since I started pursuing this dream in earnest in 2013. I’m grateful for all your support and relieved to have not let you down :)
      </p>
